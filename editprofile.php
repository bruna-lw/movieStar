    ...
    <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Digite o seu sobrenome" value="<?php echo $userData->lastname; ?>">
            </div>
            <div class="mb-3">
              <label for="text" class="form-label">E-mail:</label>
              <input type="text" readonly class="form-control disabled" id="email" name="email" placeholder="Digite o seu e-mail" value="<?php echo $userData->email; ?>">
            </div>
          ...
          <div class="col-md-4">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" name="bio" id="bio" rows="5" placeholder="Conte um pouco sobre você..."><?php echo $userData->bio; ?></textarea>
            </div>
          </div>
        </div>
      </form>
      <div class="row" id="change-password-container">
        <div class="col-md-4">
          ...
          <p class="page-description">Digite abaixo sua nova senha e confirme.</p>
